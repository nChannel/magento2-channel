function InsertProductMatrix(ncUtil, channelProfile, flowContext, payload, callback) {
  const nc = require("../util/ncUtils");
  const referenceLocations = ["productBusinessReferences"];
  const stub = new nc.Stub("InsertProductMatrix", referenceLocations, ...arguments);
